...
//css parsing and dom manipulation    
  ...
  function savestyle(){
	...
	if(selectorgroup){
      ...
      oldstyle=oldstyle.replace(oldgenerated[0],generatedportion);
      ...
      oldstyle=oldstyle+newgenerated;
      
    }
    
    arg={newcss:oldstyle}
    
    parent.saveStyle(oldstyle)
  ...
  previewiframe.load(function(){
    var thestyle=$("#in_iframe").html();
    previewiframe.contents().find("head").append("<style>"+thestyle+"</style>");
  });